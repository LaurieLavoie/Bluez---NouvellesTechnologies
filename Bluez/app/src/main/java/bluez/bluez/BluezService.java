...
/**
 * Created by Laurie on 2015-01-24.
 */
/*
 ...
 */
public class BluezService {
    // Debugging
    private static final String TAG = "BluezService";
    private static final boolean D = true;

    // Name for the SDP record when creating server socket
    private static final String NAME = "Bluez";
     ...
     */
    public BluezService(Context context, Handler handler) {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(MenuActivity.MESSAGE_STATE_CHANGE, state, -1)
                .sendToTarget();
    }
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (BluezService.this) {
                        switch (mState) {
                            case STATE_LISTEN:
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(MenuActivity.MESSAGE_READ, bytes,
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(MenuActivity.MESSAGE_WRITE, -1, -1,
                        buffer).sendToTarget();
            } catch (IOException e) {
